                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="10" class="form-control input-sm" name="phone" id="phone" placeholder="Phone" value="<?php echo $phone; ?>" />
                                </div>        
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="int">Sub Test <span class="text-danger">*</span> <?php echo form_error('subtest') ?></label>
                                    <?php echo form_multiselect('subtest[]', $subtest_options, $subtest, 'class="form-control input-sm" id="subtest"'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="sing" name="discount_sign" required >
                                            <option value="rs" <?php echo ($discount_sign=='rs') ? 'selected="true"' : ''; ?>>Rs.</option>
                                            <option value="%" <?php echo ($discount_sign=='%') ? 'selected="true"' : ''; ?>>%</option>
                                        </select>                     
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">Discount<?php echo form_error('discount_price') ?></label>
                                    <input type="text" class="form-control" id="discount_price" name="discount_price" value="<?php echo $discount_price; ?>" readonly="true" name="text">
                                </div>        
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <input type="text" class="form-control input-sm <?php if ($select == "others") echo 'show';
                                    else echo 'hide'; ?>" 
